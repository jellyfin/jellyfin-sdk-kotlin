...
//ORIGINAL LINE: [DebuggerDisplay("Name = {Name}, Count = {RecordingCount}")] public class RecordingGroupDto : INotifyPropertyChanged
public class RecordingGroupDto implements INotifyPropertyChanged
{
	/** 
